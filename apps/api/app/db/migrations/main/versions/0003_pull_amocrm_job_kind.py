...
Revision ID: 0003_pull_amocrm_job_kind
Revises: 0002_amocrm_external_button
Create Date: 2026-04-20

NB по имени ревизии: alembic по умолчанию создаёт
``alembic_version.version_num`` как ``VARCHAR(32)``; при первой
версии ID (``0003_ck_job_kind_pull_amocrm_core`` — 35 chars)
UPDATE падал с ``StringDataRightTruncation``. Имя укорочено до
25 символов. Файл и revision-string обязаны оставаться
синхронизированы.
...
revision: str = "0003_pull_amocrm_job_kind"
